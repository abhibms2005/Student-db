...
export default function Login() {
  ...
  const demoCredentials = {
    student: { email: "alice@example.com", password: "pass" },
    faculty: { email: "bob@example.com", password: "pass" },
    proctor: { email: "proctor@example.com", password: "pass" }
  };
  ...
  async function submit(e) {
    ...
    try {
      // Call actual auth.login with role validation
      ...
      // Successful login - redirect based on user's actual role
